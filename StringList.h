...
class Undo{
		...
		Undo(string,int, string);  // this is the Undo class that contains the operation, index , and value once an operation is called.
		//private:		
			string undoarray; 		// this is the operation
			int index;				//this is the index
			string value;			//this is the value at that operation
	...
	class undostack{
		...
		public:
			...
			void insert(string str, int pos,string value);		//this is the stakck where we insert 
			Undo pop();
			
		private:
		Undo* array;				// this is our stack array
		int undocapacity;			
		int num;
	...
	undostack* stack;			//this is our undostack object.
